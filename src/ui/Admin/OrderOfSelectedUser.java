/*
 * Created by JFormDesigner on Sat Sep 11 23:52:37 CST 2021
 */
 ...
 * @author Brainrain
 */
public class OrderOfSelectedUser extends JFrame {
    public OrderOfSelectedUser() {
        initComponents();
    }
    ...
    private void thisWindowOpened(WindowEvent e) {
        // TODO add your code here
        BeanUser SelectedUser = BeanUser.getCurrentLoginUser();
        //窗体打开时加载此用户的所有订单详细信息
        DefaultTableModel tblModel = (DefaultTableModel) OrderList.getModel();
        tblModel.setRowCount(0);

        try {
            List<BeanOrder> OrderListByUserNum = new OrderManager().SearchOrderInfoByUserInfoNum(SelectedUser.getUserNum());
            //获取订单的所有信息
